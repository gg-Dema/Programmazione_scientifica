...
//puntatore a funzione, La funzione puntata ritorna un double
...
/*
    Questo programma, come tutti i programmi iteratiivi di tipo double, 
    ...
    Rifarsi al listato 17, nel capitolo 4.
    Se esso è assente, riprovare nel futuro
